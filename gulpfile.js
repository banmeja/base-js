...
gulp.task('index-build', function () {
  ...
  return gulp.src('src/index.html')
	  .pipe(inject(series(bowerComponentsBuildStream, partialsBuildStream, appJSBuildStream), {relative: false, addRootSlash: false, ignorePath: '/build/'}))
	  .pipe(gulp.dest('build'));
});
...
gulp.task('index-dist', function () {
  ...
  return gulp.src('src/index.html')
	  .pipe(inject(series(bowerComponentsDistStream, partialsDistStream, appJSDistStream), {relative: false, addRootSlash: false, ignorePath: '/dist/'}))
	  .pipe(gulp.dest('dist'));
});
