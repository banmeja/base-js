...
! function(e, t) {
    ...
    return function(e) {
        ...
        a.module("mwl.calendar").controller("MwlCalendarMonthCtrl", ["$scope", "moment", "calendarHelper", "calendarConfig", function(e, t, n, a) {
            ...
            }), r.dayClicked = function(e, t, n) {
                if (t || (r.onTimespanClick({
                        calendarDate: e.date.toDate(),
                        $event: n
                    }), !n || !n.defaultPrevented)) {
                    r.openRowIndex = null;
                    var a = r.view.indexOf(e);
                    a === r.openDayIndex ? r.openDayIndex = null : (r.openDayIndex = a, r.openRowIndex = Math.floor(a / 7))
                }
        ...
        a.module("mwl.calendar").controller("MwlCalendarYearCtrl", ["$scope", "moment", "calendarHelper", function(e, t, n) {
            ...
            e.$on("calendar.refreshView", function() {
                ...
                if (t || (a.onTimespanClick({
                    ...
                    r === a.openMonthIndex ? a.openMonthIndex = null : (a.openMonthIndex = r, a.openRowIndex = Math.floor(r / 4))
                }
