            ...
            function ($stateProvider, $urlRouterProvider) {
                $stateProvider
                    .state('index.consulta', {
                        ...
                        views: {
                            '': {
                                templateUrl: 'app/consulta/consulta.tpl.html',
                                    ...
                                    function ($scope, $state, toastr, authService, consultaService) {
                                        ...
                                        $scope.printCaso = function (row) {
                                            ...
                                            var docDefinition = {
                                                ...
                                                watermark: { text: 'PORTAL DE GESTION DE APOYO JUDICIAL EN MATERIA DE FAMILIA. DOCUMENTO DE CONSULTA. ORGANISMO JUDICIAL', opacity: 0.2 },
                    ...
                    .state('index.consulta-estado', {
                        url: 'consulta-estados',
                        params: {

                        },
                        views: {
                            '': {
                                //templateUrl: 'app/consulta/consulta-estado-sincosto.tpl.html',
                                templateUrl: 'app/consulta/consulta-estado-sincosto.tpl.html',
                                controller: ['$scope', '$state', 'toastr', 'authService', 'consultaService',
                                    function ($scope, $state, toastr, authService, consultaService) {
                                        ...
                                        //  
                                        $scope.casoImpreso = angular.copy($scope.gridOptionsImpreso);
                                        //$scope.casoImpreso.enableFiltering = true;
                                        //$scope.getsolicitudes.onRegisterApi = function(gridApi){$scope.gridApi = gridApi};

                                        $scope.casoImpreso.columnDefs = [
                                            { name: "caso", displayName: "# de Caso", width: "17%" },
                                            { name: "descTipoPersona", displayName: "Tipo Persona", width: "19%" },
                                            { name: "dpi", displayName: "Identificación", width: "19%" },
                                            { name: "fechaImpresion", displayName: "Fecha Impresión", width: "14%", cellFilter: 'date:\'dd-MM-yyyy hh:mm a\'' },
                                            { name: "dependenciaImpresion", displayName: "Impreso en", width: "27%" }
                                        ];
                                        //-----------
                                        $scope.btnOp1 = function () {
                                            $scope.opcion1 = 1;
                                            $scope.opcion2 = 0;
                                            $scope.opcion.valor = 1;

                                        }
                                        $scope.btnOp2 = function () {
                                            $scope.opcion1 = 0;
                                            $scope.opcion2 = 2;
                                            $scope.opcion.valor = 2;
                                        ...
                                        $scope.noticia = {};
                                        $scope.noticia.publicacion = 'Estimados Usuarios, se informa que el Acuerdo 66-2018 de la Corte Suprema de Justicia del 14/12/2018, autoriza la exoneración del pago de Estados de Cuenta cuando se refiere a asuntos relacionados con Pensiones Alimenticias, por lo tanto, a partir de la presente fecha, no es necesario emitir la Orden y Recibo de Ingresos Judiciales 220-C por este concepto, pudiendo emitir el Estado de Cuenta sin costo, a través del Portal de Gestión y Apoyo Judicial en Materia de Familia.'
                                        $scope.checked = null;
                                        ...
                                        $scope.btnBusquedaCaso = function () {
                                            ...
                                            if (a == null || a == "") {
                                                ...
                                                consultaService.consultaEstado(a).then(function (response) {
                                                    ...
                                                    toastr.error("Fallo de comunicación del servicio a base de datos. Cx001C2");
                                                })//finServicio                                                                                           
                                            }
                                        }
                                        ...
                                        $scope.impresion = function () {
                                            ...
                                            if($scope.opcion.valor == undefined || $scope.opcion.valor == null || $scope.opcion.valor == 0){
                                                $scope.opcion.valor = 0;
                                                console.log("ix")
                                            }
                                            if ($scope.estadoCaso == null || $scope.estadoCaso == "" || $scope.numeroIdentificacion == "" || $scope.numeroIdentificacion == null) {
                                                ...
                                                if ($scope.opcion.valor == 0) {
                                                    swal({
                                                        title: "No permitido",
                                                        text: "Seleccione al solicitante",
                                                        type: "warning",
                                                        closeOnConfirm: true,
                                                    })
                                                } else {
                                                    if ($scope.numeroIdentificacion == "" || $scope.numeroIdentificacion == null) {
                                                        swal({
                                                            title: "No permitido",
                                                            text: "Ingrese el DPI del solicitante",
                                                            type: "warning",
                                                            timer: 1250
                                                        })
                                                    } else if ($scope.numeroIdentificacion.length < 13) {
                                                        swal({
                                                            title: "No permitido",
                                                            text: "El DPI del solicitante es incorrecto",
                                                            type: "warning",
                                                        ...
                                                        $scope.valor = {}
                                                        data = {
                                                            //anio: $scope.anioRecibo,//no van sin costo
                                                            //recibo: $scope.noRecibo,//no van sin costo
                                                            caso: $scope.busqueda,
                                                            ...
                                                            dpi: $scope.numeroIdentificacion,
                                                            tipoPersona: $scope.opcion.valor
                                                        }

                                                        consultaService.reporteEc(data).then(function (response) {//va servicio sin costo
                                                            //consultaService.reporte(data).then(function (response) {//inicio servicio con costo                                                    
                                        ...
                                        limpiar = function () {
                                            ...
                                            $scope.casoImpreso.data = []; //va sin costo
                                            $scope.opcion1 = false; //va sin costo
                                            $scope.opcion2 = false; //va sin costo
                                            $scope.opcion = null;
                                            $scope.numeroIdentificacion = null; //va sin costo
                                            $scope.opcion = {
                                                valor: 0
                                            };
                                        }
                    ...
                    .state('index.consulta-historial', {
                        ...
                        views: {
                            '': {
                                templateUrl: 'app/consulta/solicitud-historial.tpl.html',
                                ...
                                controller: ['$scope', '$state', 'toastr', 'authService', 'consultaService',
                                    function ($scope, $state, toastr, authService, consultaService) {
                                        ...
                                        $scope.getsolicitudesHistorial.columnDefs = [
                                            ...
                                            { name: "anioRecibo", displayName: "Año de Recibo", width: "5%" },
                                            { name: "recibo", displayName: "Número de Recibo", width: "8%" },
                                            { name: "fechaAtencion", displayName: "Fecha Atención", width: "8%", cellFilter: 'date:\'dd-MM-yyyy hh:mm a\'' },
                                            { name: "usuarioAtencion", displayName: "Usuario Atención", width: "10%" },
                                        ...
                                        consultaService.listaHistorialEmpleado($scope.loginData.codigoEmpleado, filtro).then(function (res) {
                                            if (res.data.length > 0) {
                                                $scope.solicitudesHistorico = res.data;
                                                $scope.getsolicitudesHistorial.data = $scope.solicitudesHistorico;
                                            } else {
                                                toastr.info("No tiene solicitudes realizadas");
                                            }
                                        }, function (error) {
                                            toastr.error("Fallo de comunicación del servicio a base de datos. Ex000H1");
                                        })
                                        ...
                                        $scope.filtrarFecha = function () {
                                            ...
                                            var filtro2 = {
                                                id: 0,
                                                fechaIni: new Date($scope.calendar.fechaIni),
                                                fechaFin: new Date($scope.calendar.fechaFin),
                                                texto: null,
                                                usuarioId: 0
                                            }
                                            consultaService.listaHistorialEmpleado($scope.loginData.codigoEmpleado, filtro2).then(function (res) {
                                                if (res.data.length > 0) {
                                                    $scope.solicitudesHistorico = res.data;
                                                    $scope.getsolicitudesHistorial.data = $scope.solicitudesHistorico;
                                                } else {
                    ...
                    .state('index.operador-reimpresion', {
                        url: 'reimpresion-pin',
                        params: {},
                        views: {
                            '': {
                                templateUrl: 'app/consulta/reimpresion-pin.tpl.html',
                                controller: ['$scope', '$state', 'toastr', 'authService', 'consultaService',
                                    function ($scope, $state, toastr, authService, consultaService) {
                                        toastr.info("hola");
                                    }]
